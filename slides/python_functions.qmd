...
```python
call_me_maybe?  # you should see the docstring in live example
```
...
:::
::: {.fragment}
- <font color="red">**Question**</font>: Can you give me an example in which the positions of the input arguments are important?
:::


## Function: <font color="red">positional</font> arguments
...
::: {.fragment}
- <font color="red">**Question**</font>: What happens and what is the return of this function when $a = b = 0$?
::: 
...
::: {.fragment}
- <font color="red">**Question**</font>: How can we remember the meanings of all the input arguments if the function needs a long list of arguments?
:::

::: {.fragment}
- *Answer*: Use of <font color="blue">**keyword**</font> argument. We can specify which argument takes which value.
:::
...
::: {.fragment}
- <font color="red">**Question**</font>: Can you name any scenario that may need a lot of input arguments and thus the use of keyword arguments will benefit such cases?
:::
...
![Newton-Raphson iterations](./figures/python_functions/newton_raphson_method.png)
...
::: {.fragment}
- <font color="red">**Question**</font>: What happens if don't need to supply values to all the input arguments?
:::
::: {.fragment}
...
- <font color="red"> **Scope of variables** </font> is a very complex topic in programming in general, and deserves a separate lecture on its own.
...
::: {.fragment}
- <font color="red">**Question**</font>: What output do you expect from the following code snippet?
```python
x = 10
...
print("list_alias =", list_alias)
```
- <font color="red">**Question**</font>: What output do you expect to see?
...
```
- <font color="red">**Question**</font>: What is the value of output?
::: 
...
```
::: {.fragment}
- <font color="red">**Question**</font>: What is the code for finding the min and max values of a list $\begin{bmatrix} 1 & 3 & 5 & \ldots & 999 \end{bmatrix}$?
:::
...
```
- <font color="red">**Question**</font>: How can we define the function `concat` as described above?
...
```{python}
print_kwargs(one=1, two=2, three=3, four=4) # Then we use
```

**Explanation**

- Python packs the keyword arguments `one=1`, `two=2`, `three=3` and `four=4` into a dictionary.
- We can use `kwargs` dictionary in the function body as a *regular dictionary*.
- We can use any name, but the peculiar `kwargs` -- short for **keyword arguments** -- is widely used and has become a standard.